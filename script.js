document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    if (isValid) {
      ...
      if (firstError) {
        firstError.closest('.form-group, div, p') && firstError.scrollIntoView({ behavior: 'smooth', block: 'center' });
      }
    }
  });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אבירן דוכני מזון לאירועים והשכרת מכונות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '1f40b0f6-5475-47ab-a5e9-8d534244bec6',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '1f40b0f6-5475-47ab-a5e9-8d534244bec6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1f40b0f6-5475-47ab-a5e9-8d534244bec6';
